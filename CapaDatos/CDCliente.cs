    ...
    public class CDCliente
    {
        ...
        public string Eliminar(CDCliente cli)
        {
            ...
            try
            {
                conexion.ConnectionString = Conexion.Conn;
                conexion.Open();
                SqlCommand Cmd = new SqlCommand("speliminar_ciente", conexion);
                Cmd.CommandType = CommandType.StoredProcedure;
        ...
        public DataTable BuscarNombre(CDCliente cli)
        {
            ...
            {
                conexion.ConnectionString = Conexion.Conn;
                SqlCommand Cmd = new SqlCommand("sqbuscar_cliente_nombre", conexion);
                Cmd.CommandType = CommandType.StoredProcedure;
        ...
        public DataTable BuscarDni(CDCliente cli)
        {
            ...
            {
                conexion.ConnectionString = Conexion.Conn;
                SqlCommand Cmd = new SqlCommand("sqbuscar_cliente_dni", conexion);
                Cmd.CommandType = CommandType.StoredProcedure;
